...
xrun -access +rwc -define CIPHER -uvm -sv +incdir+../env +incdir+../AES_CORE \
         ...
         -coverage all -covwork cov_work -covoverwrite -R 
    xrun -access +rwc -define CIPHER -uvm -sv +incdir+../env +incdir+../AES_CORE \
         -sv_lib `pwd`/../AES128-C-master/_sv_export.so aes_tb.sv \
         -coverage all -covtest "all" -covwork cov_work -input run_wave.tcl